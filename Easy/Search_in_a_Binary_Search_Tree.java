...
value. You need to find the node in the BST that the node's
value equals the given value. Return the subtree rooted with
...
you would see the expected output (serialized tree format) as [], not null.
*/
    
    // O(n) runtime, n = # nodes in tree
