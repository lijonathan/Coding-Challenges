...
that you cannot manipulate the file directly.
...
/*
    Approach: Pass in to read4 a buf array of size 4. Keep count of the total total
              number of characters read after each call to read4 and stop if either
              the total number after one call is < 4 or the total count reaches n.
*/
    ...
    // Memory Usage: 37.1 MB, less than 87.61% of Java online submissions 
